...
class LumenAgentTest {
    ...
    @Test
    fun chat_withEmptyApiKey_returnsError() { runBlocking {
    ...
    @Test
    fun chat_withInvalidApiKey_returnsError() { runBlocking {
    ...
    @Test
    fun chat_withValidConfig_returnsResponse() { runBlocking {
